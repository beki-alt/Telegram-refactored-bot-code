...
class T:
    ...
    BILLING_END_PROMPT   = "📅 አዲሱን የማብቂያ ቀን ቁጥር ያስገቡ (ለምሳሌ: 5):\n_(ማሳሰቢያ: የሚጀምሩትን ቀን ካለፈ መሆን አለበት — ለምሳሌ ጅምር=25 ከሆነ ማብቂያ=25 ያህል ወይም ከዚያ በላይ ይሁን)_"
    BILLING_INVALID      = "❌ ትክክለኛ ቀን (1–30) ያስገቡ:"
    BILLING_END_INVALID_ORDER = "❌ የማብቂያ ቀን ({end}) ከጅምሩ ቀን ({start}) ያነሰ ነው — ይህ ወሩን ሰነጠቀ ያስተካክሉ። 1–30 ባለው ቀን እንደገና ያስገቡ:"
