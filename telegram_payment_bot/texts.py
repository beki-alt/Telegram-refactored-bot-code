...
class T:
    ...
    BILLING_END_PROMPT   = "📅 አዲሱን የማብቂያ ቀን ቁጥር ያስገቡ (1–30):\n_(ለምሳሌ: 30 — ተመሳሳይ ወር; ወይም 5 — ሁለት ወር የሚሸፍን ዑደት)_"
    BILLING_INVALID      = "❌ ትክክለኛ ቀን (1–30) ያስገቡ:"
    BILLING_SAME_DAY_ERROR = (
        "❌ *የጅምር ቀን እና የማብቂያ ቀን ተመሳሳይ ሊሆን አይችልም።*\n\n"
        "ሌላ ቀን ያስገቡ (1–30):"
    )
    ...
    BANK_DELETED     = "🗑 *{bank_name}* ሒሳብ ተወግዷል።"
    BANK_DELETE_FAIL = "❌ ሒሳቡን ማስወገድ አልተቻለም። እንደገና ይሞክሩ።"
    BTN_DELETE_BANK  = "🗑 {bank_name}"
